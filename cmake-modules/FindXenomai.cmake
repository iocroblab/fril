...
function(PARSE_LDFLAGS _list _libraries _ldflags _libdir)
   ...
   foreach(_item ${${_list}})
      if("${_item}" MATCHES "^-l")
         set(_libraries_t ${_libraries_t} ${_item})
   ...
   string (REPLACE ";" " " _libraries_k "${_libraries_t}")
   string (REPLACE ";" " " _ldflags_k "${_ldflags_t}")
   string (REPLACE ";" " " _libdir_k "${_libdir_t}")
   
   set(${_libraries} ${_libraries_k} PARENT_SCOPE )
